    ...
    <>
      <Paper elevation={3}>
        <div className={classes.container}>
          {issue.status === "RAISED" && (
            <div className={classes.newIssue}>New</div>
          )}
          <img
            src={image}
            onError={() =>
              setImage(
                "https://firebasestorage.googleapis.com/v0/b/thrift-it-6292f.appspot.com/o/about%2FYash.jpeg?alt=media&token=51fd577a-e239-43d7-81dd-38709228ef5d"
              )
            }
        ...
        <Stack direction={"column"} spacing={0.5} sx={{ padding: 2 }}>
          ...
          <Typography variant="body2" color="text.disabled" gutterBottom noWrap>
          ...
          <Stack
            ...
            alignItems={"center"}
          >
            <Typography color={"secondary"} size="small" variant={"body2"}>
              Issue #{issue.issueId}
            </Typography>
            <StyledButton
              size={"small"}
